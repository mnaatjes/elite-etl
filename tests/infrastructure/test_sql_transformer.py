...
@patch("builtins.open", new_callable=mock_open, read_data="CREATE TABLE silver.stg_test_source AS\nSELECT * FROM bronze.raw_test_source")
...
def test_postgres_sql_transformer_success(mock_connect, mock_file):
    mock_conn = MagicMock()
    ...
    transformer.execute_template("test_source.sql")
